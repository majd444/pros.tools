...
;
      ...
      #shopify-chat-prechat .actions { display: flex; justify-content: center; margin-top: auto; padding: 0; background: transparent; position: absolute; left: 14px; right: 14px; bottom: 15px; }
